...
##Random heading:    
This part is relevant, because headings automatically get an anchor. The name of this anchor is the heading with lowercase and with '-' instead of ' '.
...
@explanation: Paris is the capital and largest city of France. Learn more at [Wikipedia](https://en.wikipedia.org/wiki/Paris)
